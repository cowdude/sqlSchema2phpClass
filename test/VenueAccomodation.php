<?php
class VenueAccomodation extends Record
{
	// SQL info
	public static $_sqlTable = 'VenueAccomodations';
	public static $_sqlFields = array('venueId', 'text', 'languageId');
	public static $_sqlIdentifier = array('venueId', 'languageId');
	public static $STD_NAME = 'VenueAccomodation';
	// Fields
	private $_venueId;
	private $_text;
	private $_languageId;
